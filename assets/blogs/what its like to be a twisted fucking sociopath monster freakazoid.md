# ?
So I've done something downright sick. And maybe vile. And maybe it might make you upset to read this... if you currently daily drive a Linux machine. Basically, I've concocted a plan. The mission? **Get as close to Linux as possible without actually switching to Linux**. 

Why? Because I wish I could use linux, but the UX doesn't feel there yet.

Let me share a bit about my personal compute setup.

I'm not a Windows fanboy by any means, but my laptop and desktop both run Windows 11. Its not that I like Windows 11, its more like its least bad of all options. I've tried Linux as a kid, Ubuntu was tough back then. Recently, I tried Pop! OS, because I heard that the distro is good for people who want a linux machine that "just works" out of the box. I ran into too many issues out of the box and stopped using it after a few weeks. There were too many issues to list, but one of them was that the Pop! OS installer process kept freezing up. You know, the very first software you interact with after booting into the USB stick that has the OS on it.

But alas, I couldn't give up on the linux dream. I *know* that a free and fully open source operating system is the future and the way to go for me personally. I know how awful Microsoft's privacy practices are, and more generally how hostile their attitude towards their own users. But I just... can't switch. Not yet at least. The level of jank is just too high still.


To be clear on what mattered to me, here is what I set out to get (✅ = I achieved it, 🤷🏻‍♂️ = I'm kinda getting there, 😩 = not yet):
...
MSYS2 is cool and out of the box comes with most of the bash programs you're familiar with. Tip: use UCRT64, its the "default" recommended one by the maintainers.
